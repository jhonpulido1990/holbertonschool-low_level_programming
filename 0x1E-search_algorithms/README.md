...
## Details
      By Wilfried Hennuyer          Weight: 1                Ongoing project - started Jun 10, 2022 , must end by Jun 13, 2022           - you're done with 0% of tasks.              Checker will be released at Jun 11, 2022 12:00 PM        An auto review will be launched at the deadline      ## Resources
Read or watch :
...
## Tasks
### 0. Linear search
          mandatory         Progress vs Score  Task Body Write a function that searches for a value in an array of integers using the  [Linear search algorithm](https://intranet.hbtn.io/rltoken/60Mr-aRkqqgLCHEF9HZ64A) 
