...
## Details
      By Julien Barbier          Weight: 1              Project over - took place from 10-28-2021 to 10-29-2021          - you're done with 100% of tasks.              An auto review will be launched at the deadline      #### In a nutshell…
* Auto QA review:          34.25/36 mandatory            &            0.0/21 optional      
* Altogether:         95.14%* Mandatory: 95.14%
* Optional: 0.0%
*               Calculation:                   95.14%                    + (95.14% * 0.0%)               == 95.14%
...
*  ` realloc ` 
## Learning Objectives
At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/ahat4zA8ssXZCSJ6eU2JdA) 
...
#### 
 ...
 Quiz question Body To allocate enough space for an array of 10 integers (on a 64bit, Linux machine), I can use:
 Quiz question Answers * malloc(64 * 10)
...
* malloc(10 * sizeof(int))
 ...
 Quiz question Body If I want to copy the string “Best School” into a new space in memory, I can use this statement to reserve enough space for it (select all valid answers):
 Quiz question Answers * malloc(sizeof(“Best School”))
...
* malloc(strlen(“Best School”) + 1)
 ...
 Quiz question Body malloc returns a pointer
...
* False
 ...
 Quiz question Body malloc returns an address
 Quiz question Answers * True
...
* False
 ...
 Quiz question Body What is wrong with this code:
 ` 
...
int cp(void)
{
 ...
 `  Quiz question Answers * You don’t have enough space to store the copy of the string “Best School”
...
* malloc can fail so we should check its return value all the time before using the pointers returned by the function.
 ...
 Quiz question Body You can do this:
 ` free("Best School");
...
* No
 ...
 Quiz question Body The memory space reserved when calling   ` malloc `   is on:
 Quiz question Answers * The stack
...
* The heap
 ...
 Quiz question Body What will you see on the terminal?
 ` int main(void)
{
    int *ptr;
...
### 0. Trust no one
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that allocates memory using   ` malloc `  .
...
### 1. string_nconcat
          mandatory         Progress vs Score           Score: 80.56% (Checks completed: 100.00%)         Task Body Write a function that concatenates two strings.
...
* File:  ` 1-string_nconcat.c ` 
 Self-paced manual review  Panel footer - Controls 
### 2. _calloc
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that allocates memory for an array, using   ` malloc `  .
...
* File:  ` 2-calloc.c ` 
 Self-paced manual review  Panel footer - Controls 
### 3. array_range
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that creates an array of integers.
...
* File:  ` 3-array_range.c ` 
 Self-paced manual review  Panel footer - Controls 
### 4. _realloc
          #advanced         Progress vs Score           Score: 0.00% (Checks completed: 0.00%)         Task Body Write a function that reallocates a memory block using   ` malloc `   and   ` free ` 
...
### 5. We must accept finite disappointment, but never lose infinite hope
          #advanced         Progress vs Score           Score: 0.00% (Checks completed: 0.00%)         Task Body Write a program that multiplies two positive numbers.
* Usage:  ` mul num1 num2 ` 
