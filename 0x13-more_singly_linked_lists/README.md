...
## Details
      By Julien Barbier          Weight: 1              Project over - took place from 11-15-2021 to 11-17-2021          - you're done with 100% of tasks.              An auto review will be launched at the deadline      #### In a nutshell…
* Auto QA review:          90.0/90 mandatory            &            0.0/35 optional      
...
## Learning Objectives
At the end of this project, you are expected to be able to  [explain to anyone](https://intranet.hbtn.io/rltoken/DlhcZuh0iPUH4vAgmqNAvA) 
...
## Tasks
### 0. Print list
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that prints all the elements of a   ` listint_t `   list.
...
### 1. List length
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that returns the number of elements in a linked   ` listint_t `   list.
...
* File:  ` 1-listint_len.c ` 
 Self-paced manual review  Panel footer - Controls 
### 2. Add node
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that adds a new node at the beginning of a   ` listint_t `   list.
...
### 3. Add node at the end
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that adds a new node at the end of a   ` listint_t `   list.
...
* File:  ` 3-add_nodeint_end.c ` 
 Self-paced manual review  Panel footer - Controls 
### 4. Free list
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that frees a   ` listint_t `   list.
...
* File:  ` 5-free_listint2.c ` 
 Self-paced manual review  Panel footer - Controls 
### 6. Pop
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that deletes the head node of a   ` listint_t `   linked list, and returns the head node’s data (n).
...
* File:  ` 6-pop_listint.c ` 
 Self-paced manual review  Panel footer - Controls 
### 7. Get node at index
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that returns the nth node of a   ` listint_t `   linked list.
...
* File:  ` 7-get_nodeint.c ` 
 Self-paced manual review  Panel footer - Controls 
### 8. Sum list
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that returns the sum of all the data (n) of a   ` listint_t `   linked list.
...
* File:  ` 9-insert_nodeint.c ` 
 Self-paced manual review  Panel footer - Controls 
### 10. Delete at index
          mandatory         Progress vs Score           Score: 100.00% (Checks completed: 100.00%)         Task Body Write a function that deletes the node at index   ` index `   of a   ` listint_t `   linked list.
...
* File:  ` 10-delete_nodeint.c ` 
 Self-paced manual review  Panel footer - Controls 
### 11. Reverse list
          #advanced         Progress vs Score           Score: 0.00% (Checks completed: 0.00%)         Task Body Write a function that reverses a   ` listint_t `   linked list.
...
### 12. Print (safe version)
          #advanced         Progress vs Score           Score: 0.00% (Checks completed: 0.00%)         Task Body Write a function that prints a   ` listint_t `   linked list.
...
### 13. Free (safe version)
          #advanced         Progress vs Score           Score: 0.00% (Checks completed: 0.00%)         Task Body Write a function that frees a   ` listint_t `   list.
...
* File:  ` 102-free_listint_safe.c ` 
 Self-paced manual review  Panel footer - Controls 
### 14. Find the loop
          #advanced         Progress vs Score           Score: 0.00% (Checks completed: 0.00%)         Task Body Write a function that finds the loop in a linked list.
